...
Complete guide for testing the pet-chip-platform-platform API endpoints.

## Quick Start

1. Ensure Docker services are running:
   ```bash
   cd d:\UNV\pet-chip-platform-platform
   bun run docker:up
   ```
...
```json
{
  ...
  "collectionName": "pet-chip-platform-platform API",
  "collectionId": "pet-chip-platform-platform-api",
  "requests": [
    {
