...
/**
 * pet-chip-platform Animal Registry API
...
const app = new Elysia()
    ...
    .use(
        swagger({
            documentation: {
                info: {
                    title: 'pet-chip-platform Animal Registry API',
                    version: '1.0.0',
    ...
    // ============================================================================
    .get('/', () => ({
        message: 'pet-chip-platform Animal Registry API',
        version: '1.0.0',
